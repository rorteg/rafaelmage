...
class Uecommerce_Mundipagg_Test_Selenium_Abstract extends PHPUnit_Extensions_Selenium2TestCase {
    ...
    protected static $_custmerTest = array(
        'firstname' => 'Test',
        'lastname' => 'Test',
        'email' => 'mundipagg@mundipagg.com.br',
    ...
    protected static $_defaultSleep = 25;
...
//endif;
    ...
    public function registerCustomer(){
        ...
        $this->byId('billing:street1')->value(self::$_custmerTest['street1']);
        $this->byId('billing:city')->value(self::$_custmerTest['city']);
        $this->byId('billing:country_id')->value(self::$_custmerTest['country_id']);
        $this->byId('billing:postcode')->value(self::$_custmerTest['postcode']);
        $this->byId('billing:telephone')->value(self::$_custmerTest['telephone']);
